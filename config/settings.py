...
class BaseConfig:
    ...
    RANDOM_FOREST_TREES = _as_int("RANDOM_FOREST_TREES", 500)
    ...
    XGBOOST_MAX_DEPTH = _as_int("XGBOOST_MAX_DEPTH", 6)
    XGBOOST_LEARNING_RATE = _as_float("XGBOOST_LEARNING_RATE", 0.03)
    XGBOOST_SUBSAMPLE = _as_float("XGBOOST_SUBSAMPLE", 0.9)
    XGBOOST_COLSAMPLE_BYTREE = _as_float("XGBOOST_COLSAMPLE_BYTREE", 1.0)
    XGBOOST_DEVICE = os.getenv("XGBOOST_DEVICE", "cuda").strip().lower()
